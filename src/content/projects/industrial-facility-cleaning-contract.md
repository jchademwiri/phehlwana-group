...
images:
  - '/images/projects/project-06.jpeg'
  - '/images/projects/project-07.jpeg'
featured: false
published: true
---

An ongoing contract cleaning and waste management programme for a large manufacturing facility in Rosslyn, Pretoria. The contract covers daily industrial cleaning, scheduled deep cleans, hazardous waste collection, and full NEM:WA compliance documentation.

## Contract Scope

Phehlwana Group provides a dedicated on-site cleaning team supported by our waste management division. Services delivered under the contract include:
...
Since the commencement of the contract, the client has reported a measurable improvement in housekeeping standards across the facility, a reduction in waste disposal costs through improved recycling rates, and zero compliance findings during two external environmental audits.
