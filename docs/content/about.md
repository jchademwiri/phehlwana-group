...
Keywords:    about Phehlwana Group, construction company Pretoria, CIDB registered
             contractor, BBBEE construction South Africa, civil engineering Gauteng
```
...
**Page subtitle:** Building South Africa since 2015
...
**Heading:** A Decade of Building Excellence

**Body copy:**
> Phehlwana Group Investments was founded in 2015 with a clear purpose: to provide
> high-quality, reliable construction and engineering services to clients who deserved
> better than the status quo. Starting with a small but dedicated team, the company
> quickly earned a reputation for professionalism, attention to detail, and getting
> the job done right.
>
...
**Alt text:** "Phehlwana Group team on a completed construction project"

> **[TODO: Replace with a real team or project photo]**
...
**Heading:** Registered, Certified, and Compliant

> Phehlwana Group Investments operates in full compliance with South African regulatory
> requirements. Our accreditations give clients the confidence that every project is
> managed to the correct legal and professional standards.
...
**Intro copy:**
> Our management team brings together decades of combined experience across construction,
> engineering, operations, and business management. Every project benefits from their
> hands-on leadership and commitment to quality.
...
**Heading:** Trusted by Clients Across South Africa

> **[TODO: Add 2–3 written testimonials from satisfied clients. For each include:]**
> - Quote (2–4 sentences)
> - Client name and job title
> - Company name (if permitted)
> - Project type

**Example format:**

> *"Phehlwana Group delivered our office renovation on time and within budget. Their
...
| # | Item                              | Notes                                                        |
|---|-----------------------------------|--------------------------------------------------------------|
| 1 | Our Story narrative               | Founding story, key milestones, growth journey               |
| 2 | CIDB registration details         | Grade, category, registration number                         |
