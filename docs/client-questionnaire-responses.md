...
> ✅ = Confirmed | 🟡 = Partial / needs follow-up | 🔴 = Critical action required
...
✅ **Confirmed correct:** Office No 06, PKN Office Park, 62 Taaifontein Street, Montana Park, Pretoria, 0182

**10. Is there a secondary or site office address?**
Not answered.

**11. What is the main office telephone number?**
✅ **Confirmed correct:** 012 655 0284
...
✅ **Confirmed correct:** info@phehlwanagroup.co.za
...
> **Action:** Verify the Google Business Profile is claimed and up to date. Update address, hours, and photos.

> **Action:** Keep all social links as `#` until Billy provides the confirmed URLs. Do not publish placeholder/wrong URLs.

---

## Section 4: Services

**28. Active services (confirmed):**
...
**29. Services to promote:**
✅ **All services promoted equally.**

**30. Plant Hire equipment (updated list):**
✅ Add **Grader** to the existing fleet list.
> Full updated list: TLB, Water Carts, Tipper Trucks, Excavators, Bulldozers, Grader, Tools, Generators
...
> - Sbusiso Mashilwane: job title, full bio, qualifications, LinkedIn
...
**50. Project details (5–10 notable projects):**
🟡 **Available but currently unorganised.** Client confirmed photos and project info exist but haven't been compiled.
> **Action:** Send client a simple project submission template (name, description, client, location, year, photos) and request they complete it for at least 6 projects.

**51. Photos/videos available?**
🟡 **Yes, but currently unorganised.**
> **Action:** Request a Google Drive or Dropbox link. Offer to assist with organisation.

**52. Named clients (with permission to mention):**
✅ **City of Tshwane, Sanparks, AgriSkills, JB Levelling, Magalies Water, Civicon**
> **Action:** These can be displayed on the website. Add to About page and Projects page. Consider adding client logos if they can be sourced.

**53. Project count (currently "129+"):**
...
**58. Tone and feeling:**
✅ **Professional & Corporate, Approachable & Local, Trustworthy & Established, Innovative & Forward-Thinking**

**59. Design elements to keep from current site:**
Not specified.

---

## Section 8: Website Goals & Target Audience
...
**61. Primary CTA (most important action):**
✅ **View the portfolio / case studies**
> **Action:** The Projects page should be the most prominent internal link on the homepage and navigation. Consider making "View Our Projects" the primary hero CTA rather than "Request a Quote."

**62. How current clients find them:**
...
> This confirms the audit findings. Broken CTAs and disorganised content are the primary pain points. Fixing navigation and CTAs is Phase 1 priority.

**Overall satisfaction with current website:** 5/10
...
- [ ] Add named clients to About/Projects pages
- [ ] Add Grader to Plant Hire equipment list
- [ ] Update founding story to reference 2015 founding and 2020 re-registration
- [ ] Fix all broken CTA buttons and navigation links

### Follow Up With Client
- [ ] CIDB full registration number
- [ ] BBBEE certificate document
- [ ] ISO 45001 certificate document
- [ ] NHBRC registration number
- [ ] 2020 company registration number
...
**Submitted by:** Phehlwana Group Investments (via Google Form)
**Responses processed by:** Apex Web Solutions / Claude
